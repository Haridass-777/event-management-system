...
import Login from './Login'; // your new styled login component
...
function Landingpage({ setRole }) {
  ...
  // Handle role and navigation
  const handleRoleSelection = (role) => {
    setRole(role);
    localStorage.setItem("role", role);
    if (role === "student") navigate("/studentdashboard");
    else if (role === "clubhead") navigate("/clubheaddashboard");
    ...
    <div className="page1-background">
      ...
      {showLogin && (
        <div className="modal-overlay" onClick={closeModal}>
          <div
            className="modal-content login-popup"
